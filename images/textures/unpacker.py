...
def frames_from_data(filename, format):
    if format == 'plist':
        ...
        for f in data['frames']:
            x = int(data['frames'][f]["frame"]["x"])
            y = int(data['frames'][f]["frame"]["y"])
            w = int(data['frames'][f]["frame"]["h"] if data['frames'][f]['rotated'] else data['frames'][f]["frame"]["w"])
            h = int(data['frames'][f]["frame"]["w"] if data['frames'][f]['rotated'] else data['frames'][f]["frame"]["h"])
            real_w = int(data['frames'][f]["sourceSize"]["h"] if data['frames'][f]['rotated'] else data['frames'][f]["sourceSize"]["w"])
            real_h = int(data['frames'][f]["sourceSize"]["w"] if data['frames'][f]['rotated'] else data['frames'][f]["sourceSize"]["h"])
            d = {
                'box': (
                    x,
                    y,
